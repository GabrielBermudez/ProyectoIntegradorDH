...
MySQL - 5.5.5-10.4.11-MariaDB : Database - movies_db
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`movies_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
/*Data for the table `actor_episode` */
...
insert  into `genres`(`id`,`created_at`,`updated_at`,`name`,`ranking`,`active`) values (1,'2016-07-04 00:00:00',NULL,'Comedia',1,1),(2,'2014-07-04 00:00:00',NULL,'Terror',2,1),(3,'2013-07-04 00:00:00',NULL,'Drama',3,1),(4,'2011-07-04 00:00:00',NULL,'Accion',4,1),(5,'2010-07-04 00:00:00',NULL,'Ciencia Ficcion',5,1),(6,'2013-07-04 00:00:00',NULL,'Suspenso',6,1),(7,'2005-07-04 00:00:00',NULL,'Animacion',7,1),(8,'2003-07-04 00:00:00',NULL,'Aventuras',8,1),(9,'2008-07-04 00:00:00',NULL,'Documental',9,1),(10,'2013-07-04 00:00:00',NULL,'Infantiles',10,1),(11,'2011-07-04 00:00:00',NULL,'Fantasia',11,1),(12,'2013-07-04 00:00:00',NULL,'Musical',12,1);
...
insert  into `users`(`id`,`name`,`email`,`password`,`remember_token`,`created_at`,`updated_at`) values (1,'Gabriel','gabrielbermudez0@gmail.com','$2y$10$EVfg4SYHil2Tu7KczS3G5.8C1ihUyjyFPq9xpFpeD.k9H9Lo/aUKW',NULL,'2020-07-13 21:57:38','2020-07-13 21:57:38'),(2,'Admin','admin@gmail.com','$2y$10$EpQe1v49/zbrYntvfIRpXe6FlCV1GKzevqgZMHKMFU/qaLCwG59x.',NULL,'2020-07-13 23:19:37','2020-07-13 23:19:37');
